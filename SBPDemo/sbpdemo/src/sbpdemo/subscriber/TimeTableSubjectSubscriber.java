...
import systemic.sif.sbpframework.subscriber.SBPNoDOCSubscriber;
import systemic.sif.sifcommon.mapping.MappingInfo;
import systemic.sif.sifcommon.model.SIFEvent;

public class TimeTableSubjectSubscriber extends SBPNoDOCSubscriber
{
	public TimeTableSubjectSubscriber(String subscriberID)
	{
		super(subscriberID, SchoolDTD.TIMETABLESUBJECT);
	}
