...
import sbpdemo.publisher.iterator.StaffPersonalEventIterator;
...
public class StaffPersonalPublisher extends SBPBasePublisher
{
	public StaffPersonalPublisher(String publisherID)
	{
		super(publisherID, StudentDTD.STAFFPERSONAL);
	}
    ...
    public SIFEventIterator getSIFEvents() throws ADKException
    {
		...
		return new StaffPersonalEventIterator();
    }
}
