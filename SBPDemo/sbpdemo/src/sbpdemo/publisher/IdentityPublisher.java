 ...
 *
 */
public class IdentityPublisher extends SBPBasePublisher
{
	public IdentityPublisher(String publisherID)
	{
		super(publisherID, InfraDTD.IDENTITY);
	}
